...
public class NodeParenttobsender extends ComponentDefinition {

	Positive<Network> network = requires(Network.class);
    Positive<Timer> timer = requires(Timer.class);
    
    public NodeParenttobsender(){
        ...
        Component sender = create(tobSenderComponent.class, Init.NONE);
      ...
      //connect required internal components to network and timer
        ...
        connect(sender.getNegative(TotalOrderBroadcastPort.class), tob.getPositive(TotalOrderBroadcastPort.class), Channel.TWO_WAY); 
